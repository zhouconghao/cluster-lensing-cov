...
class DemoCosmoDC2(object):
    ...
    def __init__(
        ...
        if os.path.isdir(self.output_loc) == False:
        ...
        self.cov_cosmic_shear_fname = (
            self.output_loc + "DeltaSigma_cov_cosmic_shear.dat"
        )
        self.cov_shape_noise_fname = self.output_loc + "DeltaSigma_cov_shape_noise.dat"
        self.cov_combined_fname = (
    ...
    def calc_cov_full(self, diag_only):
        ...
        cov_combined = (
            cov_cosmic_shear / self.co.h**2 + cov_shape_noise / self.co.h**2
        )

        np.savetxt(
            self.cov_cosmic_shear_fname, cov_cosmic_shear / self.co.h**2
        )  # h^2Msun^2/Mpc^4
